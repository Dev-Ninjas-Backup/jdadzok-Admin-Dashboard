...
import PayoutModal from "./PayoutModal"; // Ensure this modal component exists
...
const PayoutManagementTable: React.FC<{ data: Transaction[] }> = ({ data }) => {
  ...
  const handleViewDetails = (product: Transaction) => {
            ...
            <div className="px-4 py-4 sm:flex sm:items-center sm:justify-end">
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="text-[#0A0A0A] sm:text-base text-xs cursor-pointer hover:bg-gray-100 border border-[#0000001a] px-2 py-1.5 rounded-lg transition-colors"
                >
                  View Details
                </button>
              </div>
