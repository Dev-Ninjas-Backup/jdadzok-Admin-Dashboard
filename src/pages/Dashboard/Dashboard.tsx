...
// import { RecentReports } from "@/components/RecentReports"
import { Users, Building2, Calendar, ShoppingBag, TrendingUp } from "lucide-react"
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="flex items-start justify-between py-8 border-b border-gray-200 bg-white">
        ...
        <button className="bg-gray-900 hover:bg-gray-800 text-white px-6 py-2 rounded-lg">Download Report</button>
      </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-start justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600 text-sm mt-1">Monthly active users</p>
              </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-start justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600 text-sm mt-1">Monthly revenue in USD</p>
              </div>
            </div>
            <ResponsiveContainer width="100%" height={300}>
